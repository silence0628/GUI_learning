...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.resultText.setGeometry(QtCore.QRect(170, 100, 551, 451))
        self.resultText.setText("")
        self.resultText.setObjectName("resultText")
        self.startButton = QtWidgets.QPushButton(self.centralwidget)
        self.startButton.setGeometry(QtCore.QRect(270, 570, 80, 31))
        self.startButton.setObjectName("startButton")
        self.endButton = QtWidgets.QPushButton(self.centralwidget)
        self.endButton.setGeometry(QtCore.QRect(500, 570, 84, 27))
        self.endButton.setObjectName("endButton")
        self.openButton = QtWidgets.QPushButton(self.centralwidget)
        self.openButton.setGeometry(QtCore.QRect(810, 30, 84, 27))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.endButton.setText(_translate("MainWindow", "结束"))
        self.openButton.setText(_translate("MainWindow", "打开文件夹"))
